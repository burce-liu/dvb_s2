...
//获取H11的行数
            int rows_H11 = sizeof(H11) / sizeof(H11[0]);

// 获取数组的列数
            int cols_H11 = sizeof(H11[0]) / sizeof(H11[0][0]);

// 获取数组的行数
            int rows_H12 = sizeof(H12) / sizeof(H12[0]);

// 获取数组的列数
            int cols_H12 = sizeof(H12[0]) / sizeof(H12[0][0]);




            for(int i=0;i<k/360;i++)//循环赋值
            {
                if(i<rows_H11)
                {
                    for(int k1=0;k1<360;k1++)//360数据一组
                    {
                        if(k1==0)
                        {
                        ...
                        {
                            for(int j=0;j<cols_H11;j++)
                            {p[(H11[i][j]+k1*q)%m]=p[(H11[i][j]+k1*q)%m]^data[i*360+k1];}
                        }
                    }
                }
                else
...
//异或
            ...
            const int H12[40][3] = {{39948, 28229, 24899},
                                    {17408, 14274, 38993},
                                    {38774, 15968, 28459},
                                    {41404, 27249, 27425},
                                    {41229, 6082,  43114},
...
//异或
            ...
            const int H12[48][3] = {{17287, 27292, 19033},
                                    {25796, 31795, 12152},
                                    {12184, 35088, 31226},
                                    {38263, 33386, 24892},
                                    {23114, 37995, 29796},
...
//异或
            ...
            const int H12[54][3] = {{0,     14567, 24965},
                                    {1,     3908,  100},
                                    {2,     10279, 240},
                                    {3,     24102, 764},
                                    {4,     12383, 4173},
...
//异或
            ...
            const int H12[72][3] = {{0,     18539, 18661},
                                    {1,     10502, 3002},
                                    {2,     9368,  10761},
                                    {3,     12299, 7828},
                                    {4,     15048, 13362},
...
//异或
            ...
            const int H12[108][3] = {{12,   13800, 14161},
                                     {13,   2948,  9647},
                                     {14,   14693, 16027},
                                     {15,   20506, 11082},
                                     {16,   1143,  9020},
...
//异或
            ...
            const int H12[120][3] = {{15, 3149,  11981},
                                     {16, 13416, 6906},
                                     {17, 13098, 13352},
                                     {18, 2009,  14460},
                                     {19, 7207,  4314},
...
//异或
            ...
            const int H12[126][3] = {{18, 10155, 4210},
                                     {19, 1010,  10483},
                                     {20, 8900,  10250},
                                     {21, 10243, 12278},
                                     {22, 7070,  4397},
...
//异或
            ...
            const int H12[135][3] = {{15,    6304,  7621},
                                     {16,    6498,  9209},
                                     {17,    7293,  6786},
                                     {18,    5950,  1708},
                                     {19,    8521,  1793},
...
//异或
            ...
            const int H12[140][3] = {{0,  5156, 6166},
                                     {1,  1504, 4356},
                                     {2,  130,  1904},
                                     {3,  6027, 3187},
                                     {4,  6718, 759},
...
//异或
            ...
            const int H12[144][3] = {{0,  6118, 5405},
                                     {1,  2994, 4370},
                                     {2,  3405, 1669},
                                     {3,  4640, 5550},
                                     {4,  1354, 3921},
...
//异或
            ...
            if (modcod == 1) {
                ...
                const int H12[5][3] = {{7844, 3079,  10773},
                                       {3385, 10854, 5747},
                                       {1360, 12010, 12202},
                                       {6189, 4241,  2343},
                                       {9840, 12726, 4977}
...
//异或
                ...
                const int H12[10][3] = {{1505,  5682, 7778},
                                        {7172,  6830, 6623},
                                        {7281,  3941, 3505},
                                        {10270, 8669, 914},
                                        {3622,  7563, 9388},
...
//异或
                ...
                const int H12[12][3] = {{1652, 8171, 1435},
                                        {3366, 6543, 3745},
                                        {9286, 8509, 4645},
                                        {7397, 5790, 8972},
                                        {6597, 4422, 1799},
...
//异或
                ...
                const int H12[15][3] = {{0,  4046, 6934},
                                        {1,  2855, 66},
                                        {2,  6694, 212},
                                        {3,  3439, 1158},
                                        {4,  3850, 4422},
...
//异或
                ...
                const int H12[18][3] = {{0,  2161, 2653},
                                        {1,  1380, 1461},
                                        {2,  2502, 3707},
                                        {3,  3971, 1057},
                                        {4,  5985, 6062},
